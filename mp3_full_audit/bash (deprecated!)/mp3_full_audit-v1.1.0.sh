...
########################
# Helper: Load Playnite CSV (if present)
########################
load_playnite_csv() {
    local csv_file=""

    # If default exists, use it; otherwise ask user if they want to specify one.
    ...
    while IFS= read -r line; do
        ...
        # Basic CSV split by comma (assuming no embedded commas)

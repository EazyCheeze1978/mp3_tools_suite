...
# v1.0.5 — Corrected Preview Totals + WSL-Compatible Parallel Worker
#############################################
...
# -------- Parallelized Reduction Mode (WSL-Compatible) --------
reduce_mode() {
    echo ""

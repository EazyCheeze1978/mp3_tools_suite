...
# ------------------------------------------------------------
# SECTION: CSV Input Loader (NEW in 0.3.1)
# ------------------------------------------------------------
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "MP3 Reduce Tool — v0.3.1 (Python Port, Windows Only)\n\n"
            "Adds optional CSV Input support for UniPlaySong users.\n"
            "If --csv is provided, directory scanning is skipped entirely.\n"
            "All reduction logic remains unchanged from v0.3.0.\n"
        ),
    ...
    for mp3 in discovered_files:
        ...
        # Skip if a reduced version already exists
        ...
        # Skip if already 128 kbps or lower

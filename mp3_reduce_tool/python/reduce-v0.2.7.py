#!/usr/bin/env python3
# ------------------------------------------------------------
# MP3 Reduce Tool — v0.2.7
# ------------------------------------------------------------
# Changes in 0.2.7:
# - Updated --help output with full descriptive text
# - Updated argparse description and flag help strings
# - No logic or behavior changes from 0.2.6
# - Final polish release for the 0.2.x milestone
# ------------------------------------------------------------
...
def main():
    ...
    # argparse with updated help text
    parser = argparse.ArgumentParser(
        description=(
            "MP3 Reduce Tool — v0.2.7 (Python Port, Windows Only)\n\n"
            ...
            "  • Windows is the only supported platform as of v0.2.x.\n"
        ),

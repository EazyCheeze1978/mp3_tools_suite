#!/usr/bin/env python3
# ------------------------------------------------------------
# MP3 Reduce Tool — v0.2.6
# ------------------------------------------------------------
# Changes in 0.2.6:
# - Added --nocsv flag to suppress CSV export
# - Interactive prompt added (if not auto and not nocsv)
# - CSV export remains default behavior
# - No Linux/WSL changes (scheduled for removal in 0.3.0)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
# SECTION: Environment Detection (to be removed in 0.3.0)
# ------------------------------------------------------------
...
# ------------------------------------------------------------
def main():
    # Environment detection (to be removed in 0.3.0)
    try:
    ...
    parser = argparse.ArgumentParser(
        description="MP3 Reduce Tool — v0.2.6 (Python Port)"
    )
    parser.add_argument("--dir", "--folder", type=str,
                        help="Folder to scan for MP3 files")
    parser.add_argument("--minutes", type=int, default=None,
                        help="Only process files modified in the last X minutes")
    parser.add_argument("--auto", action="store_true",
                        help="Run fully automatically (no prompts)")
    parser.add_argument("--nocsv", action="store_true",
                        help="Suppress CSV export at the end of reduction")

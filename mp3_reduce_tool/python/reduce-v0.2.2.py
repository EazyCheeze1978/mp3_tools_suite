#!/usr/bin/env python3
# ------------------------------------------------------------
# MP3 Reduce Tool — v0.2.2
# ------------------------------------------------------------
# Changes in 0.2.2:
# - Removed docstring-style commentary to avoid SyntaxWarning
# - Added lightweight section banners
# - Disabled spinner on WSL to prevent input freeze
# - Explicit stdout flush before input() on WSL
# - Retained all path normalization improvements from 0.2.1
# ------------------------------------------------------------
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MP3 Reduce Tool — v0.2.2 (Python Port)"
    )

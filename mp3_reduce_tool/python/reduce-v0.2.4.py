#!/usr/bin/env python3
# ------------------------------------------------------------
# MP3 Reduce Tool — v0.2.4
# ------------------------------------------------------------
# Changes in 0.2.4:
# - Replaced input() on WSL with /dev/tty-based safe_input()
# - Eliminates WSL TTY freeze after multiprocessing
# - Retains all 0.2.3 improvements (ffmpeg version, banners, etc.)
# ------------------------------------------------------------
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MP3 Reduce Tool — v0.2.4 (Python Port)"
    )

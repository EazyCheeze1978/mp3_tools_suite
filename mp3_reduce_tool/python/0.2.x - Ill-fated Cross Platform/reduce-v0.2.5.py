#!/usr/bin/env python3
# ------------------------------------------------------------
# MP3 Reduce Tool — v0.2.5
# ------------------------------------------------------------
# Changes in 0.2.5:
# - Added --auto flag for fully non-interactive operation
# - Added --folder as an alias for --dir
# - Prompts are skipped entirely when --auto is used
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="MP3 Reduce Tool — v0.2.5 (Python Port)"
    )
